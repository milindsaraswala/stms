...
function copyLocalizedResources() {
	return src(`../${targetSpfxFolder}/src/webparts/**/loc/*.d.ts`).pipe(dest('./src/webparts'))
}

function triggerTargetWebPartReload() {
	return src(`../${targetSpfxFolder}/src/index.ts`).pipe(dest(`../${targetSpfxFolder}/src/`))
}
...
exports.watch = function () {
	watch(
		`../${targetSpfxFolder}/src/webparts/**/loc/*.d.ts`,
		{
			ignoreInitial: false
		},
